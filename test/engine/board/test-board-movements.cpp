...
namespace {
    ...
    void expect_notation(board::bitmap::Squares position,
                         notation::ChessNotation expected) {
...
TEST(BoardMovementsHorizontal, Left_Valid_b1) {
    auto start = "b1"_n;
    auto end_square =
        move::left(start.as_squares(default_board), default_board);
...
TEST(BoardMovementsHorizontal, Right_Valid_a1) {
    auto start = "a1"_n;
    auto end_square =
        move::right(start.as_squares(default_board), default_board);
...
TEST(BoardMovementsVertical, Down_Valid_a1) {
    auto start = "a1"_n;
    auto end_square =
        move::down(start.as_squares(default_board), default_board);
...
TEST(BoardMovementsDiagonal, Left_Up_Valid_b2) {
    auto start = "b2"_n;
    auto end_square =
        move::left_up(start.as_squares(default_board), default_board);
    expect_notation(end_square, "a1"_n);
}
...
TEST(BoardMovementsDiagonal, Left_Down_Valid_b2) {
    auto start = "b2"_n;
    auto end_square =
        move::left_down(start.as_squares(default_board), default_board);
...
TEST(BoardMovementsDiagonal, Right_Up_Valid_b2) {
    auto start = "b2"_n;
    auto end_square =
        move::right_up(start.as_squares(default_board), default_board);
...
TEST(BoardMovementsDiagonal, Right_Down_Valid_a1) {
    auto start = "a1"_n;
    auto end_square =
        move::right_down(start.as_squares(default_board), default_board);
