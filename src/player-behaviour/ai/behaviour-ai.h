...
private:
    ...
    std::vector<Piece> filter(const std::vector<Piece>& pieces, bool color) const;
    Bitmap create_attack_map(const std::vector<Piece>& pieces, bool color) const;
    ...
    void evaluate_and_update_all_movable_fields(Piece& piece, const Piece& king, const std::vector<Piece>& pieces) const;
    void update_movable_fields(bool color) const;
    Piece get_king(const std::vector<Piece>& pieces) const;
    Bitmap get_attacking_pieces(const Piece& king, const std::vector<Piece>& other_pieces) const;
