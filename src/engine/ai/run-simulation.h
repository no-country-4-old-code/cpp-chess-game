...
namespace ai::simulation
{
    ...
    ai::score::ScoreList<SIZE> run_recursive_simulation(const board::Board&, const piece::army::army_list&, size_t, u_int8_t);
    Move find_best_move(const board::Board&, const piece::army::army_list&, size_t, u_int8_t, const piece::api::ArmyDestinations&);
    
    // function definitions

    Move run_simulation(const board::Board &board,
