            ...
            for (auto& piece: my_army.pieces) {
                if (piece.type == piece::PieceType::ROCK && 
                    ...
                    if (sqrs_between & context.positions_all_armies == 0) {
                        ...
                        if (dest_king & dest_rock != 0) {
                            if ((dest_king | dest_rock) & context.under_attack_map == 0) {
