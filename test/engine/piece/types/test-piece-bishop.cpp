...
8        X  -  -  -  -  -  -  -
    ...
    */
    ...
    auto expected_observed = combine_squares(
        default_board, "b1"_n, "c2"_n, "d3"_n, "f5"_n, "g6"_n, "h7"_n, "a8"_n,
...
8        -  -  -  -  -  -  -  -
    ...
    */
    ...
    auto expected_observed =
        combine_squares(default_board, "b1"_n, "c2"_n, "d3"_n, "f5"_n, "g6"_n,
...
8        -  -  -  -  A  -  -  -
    */
    ...
    auto positions_enemy =
        combine_squares(default_board, "c2"_n, "e2"_n, "e8"_n);

    auto expected_observed =
        combine_squares(default_board, "c2"_n, "d3"_n, "f5"_n, "g6"_n, "c6"_n,
